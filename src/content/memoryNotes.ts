...
import type { MemoryNote } from "../types/content";

export const memoryNotesByLocale: Record<Locale, MemoryNote[]> = {
  en: [
    {
    ...
    },
    {
      ...
      detailImage: "/media/notes/henpri/freedom.jpg",
      assetBasePath: "/media/notes/henpri",
